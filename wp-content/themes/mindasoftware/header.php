...
<script src="<?php bloginfo('template_directory');?>/scripts/typed.js" type="text/javascript"></script>
    <script src="<?php bloginfo('template_directory');?>/scripts/typed.min.js" type="text/javascript"></script>
